    ...
    function(t, e, n) {
      (function(t, n) {
        ...
        (E["[object Float32Array]"] = E["[object Float64Array]"] = E[
          ...
          (E[u] = E[l] = E[_] = E[f] = E[j] = E[p] = E[h] = E[d] = E[g] = E[
            m
        ...
        return (
          ...
          (e.prototype.onResizeLeft = function(t, e, n, o, a, i) {
            var s = i.e,
              ...
              p = this.props,
              h = p.cols,
              d = p.preventCollision,
              y = (0, u.getLayoutItem)(f, t);
            if (y) {
              var g = void 0;
              if (d) {
              ...
              return (
                ...
                this.setState({
                  layout: (0, u.compact)(f, this.compactType(), h),
                  activeDrag: w
                }),
                this.props.onResize(f, c, y, w, s, l)
              );
            }
          }),
          (e.prototype.onResizeLeftStop = function(t, e, n, r, o, a) {
            var i = a.e,
              ...
              p = this.state.layout,
              h = this.props.cols,
              d = (0, u.getLayoutItem)(p, t);
            if (d) {
              d.w = e;
              p = (0, u.moveElement)(p, d, r, o, !0, f, this.compactType(), h);
              var y = (0, u.compact)(p, this.compactType(), h),
              ...
              return (
                ...
                this.props.onResizeStop(p, c, d, null, i, s)
              );
            }
          }),
        ...
        return (
          ...
          (e.prototype.calcWH = function(t) {
            var e = t.height,
              ...
              f = this.calcColWidth(),
              p = Math.round((n + o[0]) / (f + o[0])),
              h = Math.round((e + o[1]) / (s + o[1])),
              d = c ? u + p : i - u;
            return {
              w: (p = Math.max(Math.min(p, d), 1)),
              h: (h = Math.max(Math.min(h, a - l), 1))
            };
          }),
          ...
          (e.prototype.mixinResizable = function(t, e) {
            var n = this.props,
              ...
              l = n.maxW,
              c = n.maxH,
              f = this.state.onLeftHandle,
              p = this.calcWH({ height: e.height, width: e.width }).w,
              h = f ? a + p : r - a,
            ...
            return function(n, r) {
              ...
              if (s) {
                ...
                var p = e.calcXY(u.top, u.left),
                  ...
                  d = p.y,
                  y = e.props.i;
                return s.call(e, y, h, d, { e: n, node: o, position: u });
              }
            };
          }),
            ...
            return function(n, o) {
              ...
              if (l) {
                ...
                var f = e.props,
                  ...
                  v = g.h,
                  b = { e: n, node: a, size: i };
                if (!s) return l.call(e, p, m, v, b);
                var w = a.offsetParent,
                  x = w.offsetParent;
                if (x && w) {
                  var S = x.getBoundingClientRect(),
                    R = w.getBoundingClientRect(),
                    z = {
                      top: R.top - S.top + x.scrollTop,
                      left: R.left - S.left + x.scrollLeft
                    },
                    O = e.state.dragging;
                  switch (t) {
                    case "onResizeStart":
                      var _ = e.calcXY(z.top, z.left),
                        j = _.x,
                        D = _.y,
                        C = e.calcWH({ height: R.height, width: R.width }).w,
                        E = r({}, z, {
                          width: R.width,
                          height: R.height,
                          w: C,
                    ...
                    case "onResize":
                      if (!O)
                        throw new Error("onDrag called before onDragStart.");
                      var k = e.state.startingPositionLeft,
                        T = k.left,
                        P = k.width,
                        L = k.x,
                        M = k.w,
                        H = n.clientX - S.left + x.scrollLeft,
                        W = y[0],
                        N = (m - 1) * e.calcColWidth() + T;
                      z.left = Math.min(Math.max(H, W), N);
                      var A = e.calcPosition(0, 0, h, 0).width,
                        I = e.calcPosition(0, 0, d, 0).width,
                        B = T + P - z.left;
                      (i.width = Math.min(Math.max(B, I), A)),
                        e.setState({ dragging: z });
                      var q = r({}, b, { size: i, position: z }),
                        Y = e.calcWH({ height: i.height, width: i.width }).w,
                        X = L + M - Y;
                      return l.call(e, p, Y, v, X, D, q);
                    case "onResizeStop":
                      if (!O)
                        throw new Error("onDragEnd called before onDragStart.");
                      e.setState({ dragging: null, onLeftHandle: !1 });
                      var F = e.calcXY(O.top, O.left),
                        U = F.x,
                        G = F.y,
                        V = e.calcWH({ height: R.height, width: R.width }),
                        $ = V.w,
                        J = V.h,
                        K = e.calcPosition(U, G, $, J),
                        Q = K.left,
                        Z = K.width;
                      (z.left = Q), (z.top = O.top), (i.width = Z);
                      var tt = r({}, b, { size: i, position: z });
                      return l.call(e, p, $, J, U, G, tt);
                    default:
