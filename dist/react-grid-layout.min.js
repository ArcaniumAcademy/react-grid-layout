          ...
          return (
            a.default.Children.forEach(e, function(e, n) {
              ...
              if (o) i[n] = c(o);
                ...
                a
                  ? (s || _([a], "ReactGridLayout.children"),
                    (i[n] = c(r({}, a, { i: e.key }))))
    ...
    function(t, e, n) {
      (function(t, n) {
        ...
        (E["[object Float32Array]"] = E["[object Float64Array]"] = E[
          ...
          (E[u] = E[l] = E[_] = E[p] = E[j] = E[f] = E[h] = E[d] = E[g] = E[
            m
...
*/
	...
	*/
        ...
        var k = (function() {
            ...
            if (t in e) return "";
            for (var n = 0; n < C.length; n++) if (E(t, C[n]) in e) return C[n];
            return "";
          })(),
          T = function(t, e) {
            if (!(t instanceof e))
                ...
                value: function() {
                  ...
                  var c = this.props,
                    ...
                    y = R(
                      d.props.className || "",
                      p,
                      (L((t = {}), f, this.state.dragging),
                      L(t, h, this.state.dragged),
                      t)
                    );
        ...
        return (
          ...
          (st.defaultProps = M({}, it.defaultProps, {
            axis: "both",
            bounds: !1,
              ...
              if (l) {
                ...
                if (R && S) {
                  var O = R.getBoundingClientRect(),
                    ...
                    _ = {
                      top: z.top - O.top + R.scrollTop,
                      left: z.left - O.left + R.scrollLeft
                    },
                    j = e.state.dragging;
                  switch (t) {
                    case "onResizeStart":
                      var D = h(_.top, _.left, e.props),
                        C = D.x,
                        E = D.y,
                        k = e.calcWH({ height: z.height, width: z.width }).w,
                        T = r({}, _, {
                          width: z.width,
                          height: z.height,
                          w: k,
                    ...
                    case "onResize":
                      ...
                      var P = e.state.startingPositionLeft,
                        ...
                        H = P.x,
                        N = P.w,
                        W = n.clientX - O.left + R.scrollLeft,
                        A = m[0],
                        I = (b - 1) * f(e.props) + L;
                      _.left = Math.min(Math.max(W, A), I);
                      var B = e.calcPosition(0, 0, y, 0).width,
                        q = e.calcPosition(0, 0, g, 0).width,
                        Y = L + M - _.left;
                      (i.width = Math.min(Math.max(Y, q), B)),
                        e.setState({ dragging: _ });
                      var X = r({}, x, { size: i, position: _ }),
                    ...
                    case "onResizeStop":
                      ...
                      var G = h(j.top, j.left, e.props),
                        V = G.x,
                        $ = G.y,
                        J = e.calcWH({ height: z.height, width: z.width }),
                        K = J.w,
                        Q = J.h,
                        Z = e.calcPosition(V, $, K, Q),
                        tt = Z.left,
                        et = Z.width;
                      (_.left = tt), (_.top = j.top), (i.width = et);
                      var nt = r({}, x, { size: i, position: _ });
