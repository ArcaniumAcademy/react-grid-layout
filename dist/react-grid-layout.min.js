        ...
        (e.childrenEqual = function(t, e) {
          return (0, o.default)(
            a.default.Children.map(t, function(t) {
              var e = t.key,
                n = t.props["data-grid"].properties;
              return { key: e, properties: n };
            }),
        ...
        (e.synchronizeLayoutWithChildren = function(t, e, n, o) {
          ...
          return (
            a.default.Children.forEach(e, function(e, n) {
              ...
              if (o)
                i[n] = c(
                  r({}, o, { properties: e.props["data-grid"].properties })
                );
              else {
                !s &&
                  e.props._grid &&
    ...
    function(t, e, n) {
      (function(t, n) {
        ...
        (E["[object Float32Array]"] = E["[object Float64Array]"] = E[
          ...
          (E[u] = E[l] = E[z] = E[p] = E[j] = E[f] = E[h] = E[d] = E[g] = E[
            m
          ] = E[b] = E[x] = E[S] = E[R] = E["[object WeakMap]"] = !1);
        var k = "object" == typeof t && t && t.Object === Object && t,
          T = "object" == typeof self && self && self.Object === Object && self,
          P = k || T || Function("return this")(),
          L = e && !e.nodeType && e,
          M = L && "object" == typeof n && n && !n.nodeType && n,
          H = M && M.exports === L,
          N = H && k.process,
          W = (function() {
            try {
              ...
              : (function(t, e, n, r, o, s) {
                  ...
                  if (!(n & a)) {
                    var C = w && K.call(t, "__wrapped__"),
                      E = O && K.call(e, "__wrapped__");
                    if (C || E) {
                      var k = C ? t.value() : t,
                        T = E ? e.value() : e;
                      return s || (s = new jt()), o(k, T, n, r, s);
                    }
                  }
                  if (!D) return !1;
                  return (
        ...
        var Kt = A
          ...
          : function(t) {
              return Jt(t) && Vt(t.length) && !!E[Et(t)];
            };
        function Qt(t) {
          return null != (e = t) && Vt(e.length) && !Gt(e) ? Dt(t) : Lt(t);
          var e;
        }
      ...
      var f = (function(t) {
        ...
        return (
            ...
            (this.props.dragApiRef.value = {
              dragIn: function(n) {
                    ...
                    for (var r in t)
                      e.indexOf(r) >= 0 ||
                        (Object.prototype.hasOwnProperty.call(t, r) &&
                          (n[r] = t[r]));
                    return n;
                  })(n, ["i", "w", "h", "node", "event", "position"]);
                e = { i: o, w: a, h: i, node: s };
                var f = t.state.layout,
                  h = t.props,
                  d = h.margin,
                  y = h.containerPadding,
                  g = (0, l.calcXY)(c.top, c.left, {
                ...
                if (t.state.activeDrag)
                  t.onDrag(o, m, v, { e: u, node: s, newPosition: c });
                else {
                  var b = r({ i: o, w: a, h: i, x: m, y: v }, p);
                  t.setState({
                    oldDragItem: b,
                    oldLayout: f,
                    layout: [].concat(t.state.layout, [b]),
                    activeDrag: b
                  }),
                    t.props.onDragStart(f, b, b, null, u, s);
                }
              },
              dragOut: function() {
                if (e) {
          ...
          (e.prototype.onDragStart = function(t, e, n, r) {
            var o = r.e,
              a = r.node,
              i = (r.position, this.state.layout),
          ...
          (e.prototype.onDrag = function(t, e, n, r) {
            var o = r.e,
              a = r.node,
              i = (r.position, this.state.oldDragItem),
              s = this.state.layout,
              l = this.props.cols,
          ...
          (e.prototype.onResizeLeft = function(t, e, n, o, a, i) {
            var s = i.e,
              l = i.node,
              c = (i.size, i.position, this.state.oldResizeItem),
              p = this.state.layout,
              f = this.props,
              h = f.cols,
              d = f.preventCollision,
              y = (0, u.getLayoutItem)(p, t);
            if (y) {
              var g = void 0;
              if (d) {
              ...
              return (
                ...
                this.setState({
                  layout: (0, u.compact)(p, this.compactType(), h),
                  activeDrag: w
                }),
                this.props.onResize(p, c, y, w, s, l)
              );
            }
          }),
          (e.prototype.onResizeLeftStop = function(t, e, n, r, o, a) {
            var i = a.e,
              s = a.node,
              l = (a.size, a.position, this.state),
              c = l.oldResizeItem,
              p = l.preventCollision,
              f = this.state.layout,
              h = this.props.cols,
            ...
            if (d) {
              d.w = e;
              f = (0, u.moveElement)(f, d, r, o, !0, p, this.compactType(), h);
              var y = (0, u.compact)(f, this.compactType(), h),
              ...
              return (
                ...
                this.props.onResizeStop(f, c, d, null, i, s)
              );
            }
          }),
              ...
              var t = this.state.activeDrag,
                ...
                c = Math.max(
                  o.reduce(function(t, e) {
                    return e.y + e.h + 1 > t ? e.y + e.h + 1 : t;
                  }, 1),
                  t ? t.y + 1 : 1
                ),
                p = [],
    ...
    function(t, e, n) {
      ...
      function h(t, e, n) {
        var r = n.margin,
          ...
          u = n.maxRows,
          l = f(n),
          c = Math.floor((e - r[0]) / (l + r[0])),
          p = Math.floor((t - r[1]) / (a + r[1]));
        return {
        ...
        return (
          ...
          (e.prototype.calcPosition = function(t, e, n, r, o) {
            ...
            return (
              ...
              o &&
                o.dragging &&
                (o.resizing || (c.top = Math.round(o.dragging.top)),
          ...
          (e.prototype.calcWH = function(t) {
            var e = t.height,
              ...
              u = r.x,
              l = r.y,
              c = this.state.onLeftHandle,
              p = f(this.props),
              h = Math.round((n + o[0]) / (p + o[0])),
              d = Math.round((e + o[1]) / (s + o[1])),
              y = c ? u + h : i - u;
            return {
              w: (h = Math.max(Math.min(h, y), 1)),
              h: (d = Math.max(Math.min(d, a - l), 1))
            };
          }),
          ...
          (e.prototype.mixinResizable = function(t, e) {
            var n = this.props,
              ...
              l = n.maxW,
              c = n.maxH,
              p = this.state.onLeftHandle,
              f = this.calcWH({ height: e.height, width: e.width }).w,
              h = p ? a + f : r - a,
              d = this.calcPosition(0, 0, h, 0).width,
              y = this.calcPosition(0, 0, i, u),
              g = this.calcPosition(0, 0, l, c),
              m = [y.width, y.height],
          ...
          (e.prototype.onDragHandler = function(t) {
            ...
            return function(n, r) {
              ...
              if (s) {
                ...
                var d = h(
                    u.top + Math.round(f(e.props) / 2),
                    u.left + Math.round(e.props.rowHeight / 2),
                    e.props
                  ),
                  y = d.x,
                  g = d.y,
                  m = e.props.i;
                return s.call(e, m, y, g, { e: n, node: o, position: u });
              }
            };
          }),
          (e.prototype.onResizeHandler = function(t) {
            ...
            return function(n, o) {
              var a = o.node,
                i = o.size,
                s = a.classList.contains("react-resizable-handle-w"),
                u = {
                  onResizeStart: "onResizeStart",
                  onResize: s ? "onResizeLeft" : "onResize",
                  onResizeStop: s ? "onResizeLeftStop" : "onResizeStop"
                },
                l = e.props[u[t]];
              if (l) {
                var c = "onResizeStop" === t ? null : i;
                e.setState({ resizing: c });
                var p = e.props,
                  d = p.i,
                  y = p.maxW,
                  g = p.minW,
                  ...
                  w = v.h,
                  x = { e: n, node: a, size: i };
                if (!s) return l.call(e, d, b, w, x);
                var S = a.offsetParent,
                  R = S.offsetParent;
                if (R && S) {
                  var _ = R.getBoundingClientRect(),
                    O = S.getBoundingClientRect(),
                    z = {
                      top: O.top - _.top + R.scrollTop,
                      left: O.left - _.left + R.scrollLeft
                    },
                    j = e.state.dragging;
                  switch (t) {
                    case "onResizeStart":
                      var D = h(z.top, z.left, e.props),
                        C = D.x,
                        E = D.y,
                        k = e.calcWH({ height: O.height, width: O.width }).w,
                        T = r({}, z, {
                          width: O.width,
                          height: O.height,
                          w: k,
                    ...
                    case "onResize":
                      if (!j)
                        throw new Error("onDrag called before onDragStart.");
                      var P = e.state.startingPositionLeft,
                        L = P.left,
                        M = P.width,
                        H = P.x,
                        N = P.w,
                        W = n.clientX - _.left + R.scrollLeft,
                        A = m[0],
                        I = (b - 1) * f(e.props) + L;
                      z.left = Math.min(Math.max(W, A), I);
                      var B = e.calcPosition(0, 0, y, 0).width,
                        q = e.calcPosition(0, 0, g, 0).width,
                        Y = L + M - z.left;
                      (i.width = Math.min(Math.max(Y, q), B)),
                        e.setState({ dragging: z });
                      var X = r({}, x, { size: i, position: z }),
                        F = e.calcWH({ height: i.height, width: i.width }).w,
                        U = H + N - F;
                      return l.call(e, d, F, w, U, E, X);
                    case "onResizeStop":
                      if (!j)
                        throw new Error("onDragEnd called before onDragStart.");
                      e.setState({ dragging: null, onLeftHandle: !1 });
                      var G = h(j.top, j.left, e.props),
                        V = G.x,
                        $ = G.y,
                        J = e.calcWH({ height: O.height, width: O.width }),
                        K = J.w,
                        Q = J.h,
                        Z = e.calcPosition(V, $, K, Q),
                        tt = Z.left,
                        et = Z.width;
                      (z.left = tt), (z.top = j.top), (i.width = et);
                      var nt = r({}, x, { size: i, position: z });
                      return l.call(e, d, K, Q, V, $, nt);
                    default:
          ...
          (e.prototype.render = function() {
              ...
              o.default.cloneElement(f, {
                className: (0, l.default)(
                  ...
                  this.props.className,
                  {
                    ...
                    "react-draggable": s,
                    "react-draggable-dragging": Boolean(d),
                    cssTransforms: c
                  }
                ),
                style: r(
            ...
            return (
              u && (y = this.mixinResizable(y, p)),
              s && (y = this.mixinDraggable(y)),
              y
            );
          }),
          e
      ...
      (d.propTypes = {
        ...
        onResizeStart: a.default.func,
        onResize: a.default.func,
        onResizeLeftStop: a.default.func,
        onResizeLeft: a.default.func,
          ...
          return (
            ...
            (e.prototype.onWidthChange = function(t) {
              var e = t.breakpoints,
                ...
                c = (0, u.getColsFromBreakpoint)(a, n);
              if (
                (l !== a && this.props.cols[l] !== n[a]) ||
                !(0, i.default)(this.props.breakpoints, e) ||
                !(0, i.default)(this.props.cols, n)
              ) {
                l in r || (r[l] = (0, s.cloneLayout)(this.state.layout));
                var p = (0, u.findOrGenerateResponsiveLayout)(r, e, a, l, c, o);
                (p = (0, s.synchronizeLayoutWithChildren)(p, t.children, c, o)),
                  (r[a] = p),
                  this.props.onLayoutChange(p, r),
                  this.props.onBreakpointChange(a, c),
                  this.setState({ breakpoint: a, layout: p, cols: c });
              }
