...
function calcXY(top, left, props) {
  ...
  var x = Math.floor((left - margin[0]) / (colWidth + margin[0]));
  var y = Math.floor((top - margin[1]) / (rowHeight + margin[1]));
...
var GridItem = (function(_React$Component) {
  ...
  GridItem.prototype.onDragHandler = function onDragHandler(handlerName) {
    ...
    return function(e, _ref2) {
      ...
      var _calcXY = calcXY(
          position.top + Math.round(calcColWidth(_this2.props) / 2),
          position.left + Math.round(_this2.props.rowHeight / 2),
          _this2.props
        ),
        x = _calcXY.x,
        y = _calcXY.y;
      ...
      return handler.call(_this2, i, x, y, {
        e: e,
        node: node,
        position: position
      });
  ...
  GridItem.prototype.onResizeHandler = function onResizeHandler(handlerName) {
    ...
    return function(e, _ref3) {
      ...
      switch (handlerName) {
        case "onResizeStart":
          var _calcXY2 = calcXY(position.top, position.left, _this3.props),
            startX = _calcXY2.x,
            _y = _calcXY2.y;
        ...
        case "onResize":
          ...
          var maxLeft = (w - 1) * calcColWidth(_this3.props) + startingLeft;
        ...
        case "onResizeStop":
          ...
          var _calcXY3 = calcXY(dragging.top, dragging.left, _this3.props),
            snapX = _calcXY3.x,
            snapY = _calcXY3.y;
