...
function childrenEqual(a, b) {
  return (0, _lodash2.default)(
    _react2.default.Children.map(a, function(_ref) {
      var key = _ref.key,
        properties = _ref.props["data-grid"].properties;

      return { key: key, properties: properties };
    }),
    _react2.default.Children.map(b, function(_ref2) {
      var key = _ref2.key,
        properties = _ref2.props["data-grid"].properties;
  ...
  _react2.default.Children.forEach(children, function(child, i) {
    ...
    if (exists) {
      layout[i] = cloneLayoutItem(
        _extends({}, exists, {
          properties: child.props["data-grid"].properties
        })
      );
    } else {
